...
void ChartItem::paint(QPainter *painter)
{
	...
	for ( int i = 0 ; i < m_bars.count(); ++i )
	{
		...
		QRectF barRect( rect.x() + i * barWidth, rect.y() + qMin(barEdge1, barEdge2),
...
void ChartItem::append_var(QQmlListProperty<BarItem> *list, BarItem *bar)
{
...
{
	return QQmlListProperty<BarItem>(this, 0, &ChartItem::append_var, 0,0,0);
}
